...
export default function Hero() {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col justify-center px-10 text-left">
        <h1 className="font-mono text-3xl md:text-5xl tracking-[0.25em] text-gray-100">
          SYSTEM ONLINE
        </h1>
        <p className="mt-6 max-w-xl font-sans text-sm md:text-base text-gray-300 leading-relaxed">
